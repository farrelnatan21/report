  ...
  <section id="container">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            <a href="javascript:;">
              ...
              <span>Manajemen CRUD</span>
              </a>
            <ul class="sub">
              <li><a href="?p=kejuruan">Kejuruan</a></li>
              <li><a href="?p=konten">Project</a></li>
              <li><a href="?p=mahasiswa">Mahasiswa</a></li>
              <li><a href="?p=universitas">Universitas</a></li>
    ...
    <footer class="site-footer">
      <div class="text-center">
        <p>
          &copy; Copyrights <strong>Farrel</strong>. All Rights Reserved
        </p>
        <div class="credits">
          <!--
